...
/* harmony export */   "NoSynonymsFound": () => (/* binding */ NoSynonymsFound),
/* harmony export */   "NoThesaurusEntry": () => (/* binding */ NoThesaurusEntry),
/* harmony export */   "parseSynonyms": () => (/* binding */ parseSynonyms)
/* harmony export */ });
...
/* harmony import */ var _thesaurus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./thesaurus */ "./src/thesaurus.js");
...
function getTask() {
  ...
  return (0,_thesaurus__WEBPACK_IMPORTED_MODULE_1__.fetchSynonymsPage)(word)
    .then(page => (0,_parser__WEBPACK_IMPORTED_MODULE_2__.parseSynonyms)(page))
    .then(synonyms => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getRandomWord": () => (/* binding */ getRandomWord),
/* harmony export */   "getRandomWords": () => (/* binding */ getRandomWords)
/* harmony export */ });
function getRandomWord() {
  const wordIn = Math.floor(Math.random() * list.length);
  const word = list.splice(wordIn, 1).pop();
